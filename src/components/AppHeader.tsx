...
export function AppHeader() {
  ...
  return (
    <header className="comic-bg-header-stripes comic-border-b-1 comic-shadow-xl fixed inset-x-0 top-0 z-50 flex h-[var(--header-height)] items-center justify-between px-3 md:comic-border-b-4">
      <Link
        href="/profile"
